...
#define CTRL_X_CUBE_AI_MODE_CLASS_NUMBER         (6U)
#define CTRL_X_CUBE_AI_MODE_CLASS_LIST           {"Alarm","Bark","Liquid","Race_car_and_auto_racing","Vehicle_horn_and_car_horn_and_honking","other"}
