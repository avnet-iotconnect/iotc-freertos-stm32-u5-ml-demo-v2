...
#define CTRL_X_CUBE_AI_MODE_CLASS_NUMBER         (15U)
#define CTRL_X_CUBE_AI_MODE_CLASS_LIST           {"Alarm","Bark","Dog","Glass","Growling","Liquid","Race_car_and_auto_racing","Screech","Shatter","Splash_and_splatter","Stream","Vehicle_horn_and_car_horn_and_honking","Water","Whoosh_and_swoosh_and_swish","other"}
